...
export interface InlineResponse200 {
	 ...
	 * @memberof InlineResponse200
	 */
	requestStatus?: InlineResponse200RequestStatusEnum;
	/**
	 * Date and time on which the report request is submitted.
	 * @type {string}
	 * @memberof InlineResponse200
	 ...
	 * @memberof InlineResponse200
	 */
	reportType?: InlineResponse200ReportTypeEnum;
	/**
	 * Version of report for which the request is created. Example, v1.
	 * @type {string}
	 * @memberof InlineResponse200
 ...
 * @enum {string}
 */
export enum InlineResponse200RequestStatusEnum {
	Received = 'RECEIVED',
	Inprogress = 'INPROGRESS',
	Ready = 'READY',
	Error = 'ERROR',
 ...
 * @enum {string}
 */
export enum InlineResponse200ReportTypeEnum {
	Item = 'ITEM',
}
...
export interface InlineResponse2001 {
	...
	limit?: number;
	/**
	 * Used for pagination when more than specified limit (or default 10) records are found.
	 * @type {string}
	 * @memberof InlineResponse2001
	 */
	nextCursor?: string;
	 ...
	 * @memberof InlineResponse2001
	 */
	requests?: Array<InlineResponse200>;
}
/**
 *
 * @export
...
export interface RequestsStatusResponse {
	...
	/**
	 * List of requests
	 * @type {Array<RequestsStatusResponseRequests>}
	 * @memberof RequestsStatusResponse
	 */
	requests?: Array<RequestsStatusResponseRequests>;
}
/**
 * List of requests
 * @export
 * @interface RequestsStatusResponseRequests
 */
export interface RequestsStatusResponseRequests {
	/**
	 * Automated ID generated by system that uniquely identifies the report request.
	 * @type {string}
	 * @memberof RequestsStatusResponseRequests
	 */
	requestId?: string;
	/**
	 * Status of report request. Possible values are RECEIVED, INPROGRESS, READY, ERROR.
	 ...
	 * @memberof RequestsStatusResponseRequests
	 */
	requestStatus?: RequestsStatusResponseRequestsRequestStatusEnum;
	/**
	 * Date and time on which the report request is submitted.
	 * @type {string}
	 * @memberof RequestsStatusResponseRequests
	 ...
	 * @memberof RequestsStatusResponseRequests
	 */
	reportType?: RequestsStatusResponseRequestsReportTypeEnum;
	/**
	 * Version of report for which the request is created. Example, v1.
	 * @type {string}
	 * @memberof RequestsStatusResponseRequests
 ...
 * @enum {string}
 */
export enum RequestsStatusResponseRequestsRequestStatusEnum {
	Received = 'RECEIVED',
	Inprogress = 'INPROGRESS',
	Ready = 'READY',
	Error = 'ERROR',
 ...
 * @enum {string}
 */
export enum RequestsStatusResponseRequestsReportTypeEnum {
	Item = 'ITEM',
}
...
export const OnRequestReportApiAxiosParamCreator = function (configuration?: Configuration) {
	return {
		...
		getSingleRequestStatus: async (
			...
			const localVarPath = `/v3/reports/reportRequests/{requestId}`.replace(
				`{${'requestId'}}`,
...
export const OnRequestReportApiFp = function (configuration?: Configuration) {
	...
	return {
		...
		async getRequestsStatus(
			...
			const localVarAxiosArgs = await localVarAxiosParamCreator.getRequestsStatus(
				reportType,
				authorization,
				wMSECACCESSTOKEN,
				wMQOSCORRELATIONID,
		...
		async getSingleRequestStatus(
			...
			const localVarAxiosArgs = await localVarAxiosParamCreator.getSingleRequestStatus(
				requestId,
				authorization,
				wMSECACCESSTOKEN,
				wMQOSCORRELATIONID,
 ...
 * @export
 */
export const OnRequestReportApiFactory = function (
...
export class OnRequestReportApi extends BaseAPI {
	...
	public downloadReport(requestParameters: OnRequestReportApiDownloadReportRequest, options?: any) {
		return OnRequestReportApiFp(this.configuration)
			.downloadReport(
	...
	public generateReport(requestParameters: OnRequestReportApiGenerateReportRequest, options?: any) {
		return OnRequestReportApiFp(this.configuration)
			.generateReport(
				requestParameters.reportType,
				requestParameters.reportVersion,
				requestParameters.authorization,
				requestParameters.wMSECACCESSTOKEN,
				requestParameters.wMQOSCORRELATIONID,
				requestParameters.wMSVCNAME,
	...
	public getRequestsStatus(requestParameters: OnRequestReportApiGetRequestsStatusRequest, options?: any) {
		return OnRequestReportApiFp(this.configuration)
			.getRequestsStatus(
				...
				requestParameters.accept,
				requestParameters.reportVersion,
				requestParameters.requestStatus,
				requestParameters.requestSubmissionStartDate,
				requestParameters.requestSubmissionEndDate,
				requestParameters.wMCONSUMERCHANNELTYPE,
				options
			)
			.then((request) => request(this.axios, this.basePath));
