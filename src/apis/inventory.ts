...
export interface GetAllInventoriesNodeDTO {
	 ...
	 * @memberof GetAllInventoriesNodeDTO
	 */
	availToSellQty?: InlineResponse2001ElementsInputQty;
}
/**
 *
 * @export
...
export interface InlineObject {
	 ...
	 * @memberof InlineObject
	 */
	quantity: InlineResponse2001ElementsInputQty;
}
/**
 *
 * @export
...
export interface InlineResponse200Payload {
	/**
	 *
	 * @type {Array<InlineResponse200PayloadInventory>}
	 * @memberof InlineResponse200Payload
	 */
	inventory?: Array<InlineResponse200PayloadInventory>;
}
/**
 *
 * @export
 * @interface InlineResponse200PayloadInventory
 */
export interface InlineResponse200PayloadInventory {
	/**
	 * An arbitrary alphanumeric unique ID, specified by the seller, which identifies each item.
	 * @type {string}
	 * @memberof InlineResponse200PayloadInventory
	 */
	sku?: string;
	/**
	 *
	 * @type {Array<InlineResponse200PayloadShipNodes>}
	 * @memberof InlineResponse200PayloadInventory
	 */
	shipNodes?: Array<InlineResponse200PayloadShipNodes>;
}
/**
 *
 * @export
 * @interface InlineResponse200PayloadShipNodes
 */
export interface InlineResponse200PayloadShipNodes {
	/**
	 * Last changes date for the item.
	 * @type {string}
	 * @memberof InlineResponse200PayloadShipNodes
	 */
	modifiedDate?: string;
	/**
